...
public partial class App : Application
{
    ...
    public override void OnFrameworkInitializationCompleted()
    {
        ...
        {
            desktop.MainWindow = new MainWindow(Services.GetRequiredService<IDownloadAppService>(), Services.GetRequiredService<IAppSettings>(), Services.GetRequiredService<VideoChangeNotifier>());
    ...
    private static ServiceProvider BuildProvider()
    {
        ...
        services.AddSingleton<RedgifsAuthProvider>(_ => new RedgifsAuthProvider(new HttpClient()));
        ...
        services.AddSingleton<IUserNotificationService, AvaloniaNotificationService>();
